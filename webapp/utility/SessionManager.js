...
(function(MYSAP, $, undefined) {
    // Constructor
    MYSAP.Session = function(userName, companyId, companyname, countrycode, address, companycontact, companyemail, city, pincode, contactno2, faxnumber, userId, roleIds, roleNames, accessToken, cToken, userkey){
    ...
    MYSAP.Session.prototype.log = function(){
        console.log("User Name : " + this.userName + ', Company Id : ' + this.companyId + ', Countrycode : ' + this.countrycode + 'Company Name : ' + this.companyname + ', User Id : ' + this.userId +  ', Role Ids : ' + this.roleIds + ', Role Names : ' + this.roleNames +', Token : ' + this.token  + ', cToken : ' + this.cToken  + ', userkey : ' + this.userkey + ', Address : ' + this.address + ', companyemail : ' + this.companyemail + ', contactno : ' + this.companycontact);
    };
