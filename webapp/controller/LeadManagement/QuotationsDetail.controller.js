sap.ui.define([
	...
	return BaseController.extend("sap.ui.elev8rerp.componentcontainer.controller.LeadManagement.QuotationsDetail", {
		...
		loadPDFData: function () {
			let oThis = this;
			var quoteModel = this.getView().getModel("quoteModel");  //quotePDFModel
			var quoteid = quoteModel.oData.id;
			quotationService.getQuotationPDF({ id: quoteid }, function (data) {
